                    ...
                    <div className="page-wrapper">
                        ...
                        <section className="section first-move">
                            <div className="section__inner">
                                ...
                                <p className="section__desc animated-text">
                                    Sakamoto
                        ...
                        <section className="section second-move">
                            <div className="section__inner">
                                ...
                                <p className="section__desc">
                                    ...
                                    , 说不上是借鉴，
                                    只是简单的模仿，建模部分原有的打算是学习建造其他类型的小场景，并已经在blender完成，可惜短时间学习Blender属实是依葫芦画瓢，在拷贝大量不明所以的Shader过后，项目导出出现过多的问题,暂且放弃转头重新搭建更为简单的场景（
